            ...
            <div className="w-1/2 text-left">
              ...
              >
                ...
                <p className="my-5 text-justify">
                  Dịch vụ tư vấn và điều trị cho thú cưng là việc cung cấp các dịch vụ liên quan đến
                  sức khỏe và chăm sóc cho thú cưng như khám bệnh, điều trị, các cách thức phòng
            ...
            <div className="flex items-center justify-between gap-10">
              <div className="w-1/2 text-left">
                <div className="my-5 flex flex-col gap-5 text-justify">
                  ...
                  >
                    <p>
                      Dịch vụ tư vấn và điều trị cho thú cưng là một phần không thể thiếu trong việc
                      chăm sóc và bảo vệ sức khỏe của thú cưng. Việc khám bệnh thường xuyên và định
                      kỳ giúp phát hiện sớm các vấn đề về sức khỏe của thú cưng và phòng tránh được
                      những bệnh nguy hiểm.
                    </p>
                    <p>
                      Phòng khám Thú y GenKiKoi với đội ngũ bác sĩ chuyên khoa, trình độ cao và giàu
                      kinh nghiệm, luôn sẵn sàng tiếp nhận thú cưng của bạn. Chúng tôi luôn mong có
                      thể đáp ứng được nhu cầu chăm sóc sức khoẻ cho thú cưng một cách đa dạng nhất.
                    ...
                    <p>
                      ...
                      uy tín của khách hàng trong việc chăm sóc và bảo vệ sức khoẻ cho thú cưng.
                    </p>
                  </AnimatedSection>
                </div>
              </div>
