    ...
    <div>
      ...
      <div className="section bg-blue-primary text-center text-white">
        <div className="container mx-auto lg:px-40">
          ...
          <motion.div className="my-10 grid grid-cols-2 gap-10">
          ...
          <div className="my-10 grid grid-cols-2 gap-5">
            <div className="item-hover gap-6">
              ...
              <div className="flex-1 text-left">
                ...
                <p>
                  Với kinh nghiệm của bác sĩ trình độ chuyên môn cao, nhiều năm kinh nghiệm làm việc
                  tại Sài Gòn.
                </p>
              </div>
            </div>
            ...
            <div className="item-hover gap-6">
              ...
              <div className="flex-1 text-left">
                ...
                <p>
                  Tiêm chủng vắc xin là biện pháp phòng bệnh truyền nhiễm đơn giản và hiệu quả nhất
                  hiện nay.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto lg:px-40">
          ...
          <div className="my-10 cursor-grabbing">
            ...
            >
              ...
              <div className="mx-2 flex h-full flex-col justify-between rounded-md p-5 py-10 ring-2 ring-blue-secondary">
                <p className="mb-3 text-base">
                  Bác sĩ từ Sài Gòn mới về làm, còn trẻ nhưng chuyên môn rất cao. Cám ơn các bác sĩ
                  rất nhiều 🥰
                </p>
                <div className="text-center">
                  <Avatar
            ...
            <div className="w-1/2">
              ...
              <div className="my-6 flex gap-5">
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-justify">
                    GenKiKoi là phòng khám thú y chuyên về chăm sóc và điều trị cá Koi. Ở đây chúng
                    tôi luôn đặt chất lượng điều trị lên hàng đầu.
                  </p>
                </div>
              </div>
              ...
              <div className="my-6 flex gap-5">
                ...
                <div className="flex-1 text-left">
                  <h3 className="mb-2 text-2xl font-bold underline underline-offset-8">Tận tâm</h3>
                  <p className="text-justify">
